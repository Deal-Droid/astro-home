...
snippet: "Exploring how Large Language Models are transforming the field of conversation design."
image:
  {
    src: "../../assets/blogs/conversation-design-llm.png",
    alt: "AI Chatbot",
  }
...
import BlogImg15 from "../../assets/blogs/conversation-design-llm-2.jpg";
...
But with the advent of LLMs (Large Language Models), that dream has returned!🤩 It allows us to clearly define branding — whether we want it to respond politely or even like a dog (“Hooman, do you like our product?”) — we can shape it all! This renewed interest led me to seriously start [DealDroid](http://dealdroid.net).
...
- "สวัสดี! 我们有很好的狗粮!" (Mixed with Chinese characters)
- "こんにちは! We have great dog food" (Mixed with Japanese)
- "안녕하세요 มีอาหารสุนัขครับ" (Mixed with Korean)
